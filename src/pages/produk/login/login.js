                                                ...
                                                <div className="row">
                                                    <div className="col-lg-12 col-md-6">
                                                        ...
                                                        <div className="login_submit">
                                                            <a href="http://127.0.0.1:8000">Lost your password?</a>
                                                ...
                                                <div className="row">
                                                    <div className="col-lg-6 col-md-6">
                                                        <div className="container_login_button">
                                                            <img className="image_login" onClick={handleLoginFb} src={facebook} alt="" />
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-6 col-md-6">
                                                        <div className="container_login_button" >
                                                            <img className="image_login" onClick={handleLogin} src={google} alt="" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="row">
