...
const Detail = () => {
  ...
  return (
    ...
    <Layout>
      ...
      <>
        {/* <div> <a>{detailProduct && detailProduct.data['name']}</a></div> */}
                ...
                <div className="col-12">
                  <div className="breadcrumb_content">
                    <ul id="title_breadcumb_detail">
                      ...
                      <li>{detailProduct && detailProduct.data['type_id']}</li>
                      <li>
                        <a href="http://onlinestore.microdataindonesia.co.id/kategori/list_kategori/empty/empty/10">{detailProduct && detailProduct.data['category_id']}</a>
                      </li>
                      <li>{detailProduct && detailProduct.data['category_id']}</li>
                    </ul>
                  </div>
                </div>
              </div>
                      ...
                      <div className="product-details-tab">
                        <div id="img-1" className="zoomWrapper single-zoom">
                          <figure className='figure-img' onMouseMove={(e) => handleMouseMove(e)} style={DataUser}  >
                            ...
                            <img id="testload" className='img1' src={detailProduct && detailProduct.data['thumbnail']} alt="gambar" />
                                ...
                                <div className="owl-item active" style={{ width: '185.5px', marginRight: '10px' }}>
                                  <li>
                                    <a href="#/" className="elevatezoom-gallery active" data-update data-image="https://microdatastoreapi.cooljarsoft.com/image-barang/original/16" data-zoom-image="https://microdatastoreapi.cooljarsoft.com/image-barang/original/16">
                                      ...
                                      <img style={{ width: '110px', height: '110px' }} src={detailProduct && detailProduct.data['thumbnail']} alt="zo-th-1" />
                      ...
                      <div className="product_d_right">
                        <form action="#">
                          <h3 className="namabarang-detail">
                            <a id="namaBarang">{detailProduct && detailProduct.data['name']}</a>
                          </h3>
                          <div className="price_box">
                            <span className="current_price" id="hargaBarang">Rp. {detailProduct && detailProduct.data['price']}</span>
                          </div>
                          <div className='price_box row'>
                            <div className="col-md-2">
                              <span className="content-detail-title" style={{ fontSize: 20 }}>Sale</span>
                            </div>
                            <div className="col-md-10">
                              <span className="content-detail-main" id="garansi" style={{ fontSize: 20 }}>{detailProduct && detailProduct.data['sale_price']}</span>
                            </div>
                          </div>
                          ...
                          <div className="product_desc">
                            ...
                            <div className="row mt-2" id="shortDescription">
                              ...
                              {detailProduct && detailProduct.data['short_description']}
                              <div className='row' style={{paddingTop: 25, paddingBottom: 20}}>
                                <div className="col-md-3">
                                  <p className="" style={{ fontWeight: "bold" }}>tinggi </p>
                                  {detailProduct && detailProduct.data['package_height']}
                                </div>
                                <div className="col-md-3">
                                  <p className="" style={{ fontWeight: "bold" }}>panjang</p>
                                  {detailProduct && detailProduct.data['package_length']}
                                </div>
                                <div className="col-md-3">
                                  <p className="" style={{ fontWeight: "bold" }}>berat</p>
                                  {detailProduct && detailProduct.data['package_weigth']}
                                </div>
                                <div className="col-md-3">
                                  <p className="" style={{ fontWeight: "bold" }}>lebar</p>
                                  {detailProduct && detailProduct.data['package_width']}
                                </div>
                              </div>
                            </div>
                          </div>
                          <div className="row">
                            ...
                            <div className="col-md-10">
                              <span className="content-detail-main" id="garansi">{detailProduct && detailProduct.data['warranty_description']}</span>
                            </div>
                          </div>
                          <div className="row">
                            <div className="col-md-2">
                            ...
                            <div className="col-md-10">
                              <span className="content-detail-main" id="garansi">{detailProduct && detailProduct.data['warranty_policy']}</span>
                            </div>
                          </div>
                          <div className="row mt-2">
                            <div className="col-md-2">
                              <span className="content-detail-title">Brand:</span>
                            </div>
                            <div className="col-md-10">
                              <span className="content-detail-main" id="brand">{detailProduct && detailProduct.data['brand']}</span>
                            </div>
                          </div>
                          <div className="row mt-2">
                            <div className="col-md-2">
                              <span className="content-detail-title">jumlah:</span>
                            </div>
                            <div className="col-md-10">
                              <span className="content-detail-main" id="quantity">{detailProduct && detailProduct.data['quantity']}</span>
                            </div>
                          </div>
                          <div className="border-divider" />
                          <div className="product_desc">
                            <span className="title-deskripsi">Include: </span>
                            <div className="row mt-2" id="include"><div className="col-md-6"><li>{detailProduct && detailProduct.data['inside_box']}</li></div></div>
                          </div>
                          <div className="product_desc">
                            <span className="title-deskripsi">Exclude: </span>
                            <div className="row mt-2" id="exclude"><div className="col-md-6"><li>{detailProduct && detailProduct.data['not_include']}</li></div></div>
                          </div>
                    ...
                    <div className="col-12">
                      <div className="tabs">
                        ...
                        <div className="tab" id="generateLongdeskripsi">
                          ...
                          <p dangerouslySetInnerHTML={{ __html: detailProduct && detailProduct.data['long_description'] }}></p>
                        </div>
                        ...
                        <div className="tab">
                          <div className="row" id="generateSpesifikasi">
                            ...
                            <div className="col-md-4 spesifikasivalue">
                              <span className>{detailProduct && detailProduct.data['not_include']}</span>
                            </div>
                            <div className="col-md-2 spesifikasikey">
