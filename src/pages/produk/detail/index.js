          ...
          <div className="col-lg-5 col-md-6">
            <div className="product-details-tab">
              <div id="img-1" className="zoomWrapper single-zoom">
                <a href="#/" id="image-detail-main"><img id="zoom1" className="images-zoom-detail" src="https://microdatastoreapi.cooljarsoft.com/image-barang/original/16" data-zoom-image="https://microdatastoreapi.cooljarsoft.com/image-barang/original/16" alt="big-1" /></a>
              </div>
              <div className="single-zoom-thumb">
                <ul className="s-tab-zoom owl-carousel single-product-active owl-loaded owl-drag" id="gallery_01">
                  <div className="owl-stage-outer">
                    <div className="owl-stage" style={{transform: 'translate3d(0px, 0px, 0px)', transition: 'all 0s ease 0s', width: '364px'}}>
                      <div className="owl-item active" style={{width: '172px', marginRight: '10px'}}>
                        <li><a href="#/" className="elevatezoom-gallery active" data-update data-image="https://microdatastoreapi.cooljarsoft.com/image-barang/original/16" data-zoom-image="https://microdatastoreapi.cooljarsoft.com/image-barang/original/16"><img style={{width: '110px', height: '110px'}} src="https://microdatastoreapi.cooljarsoft.com/image-barang/original/16" alt="zo-th-1" /></a></li>
                      </div>
                      <div className="owl-item active" style={{width: '172px', marginRight: '10px'}}>
            ...
            <div className="product_d_right">
              <form action="#">
                ...
                <div className="product_desc">
                  ...
                  <div className="row mt-2" id="shortDescription">
                    <div className="col-md-6">
                      <li>Wardah Crystal Secret Foaming Cleanser with Natural AHA+PHA merupakan Foaming Cleanser dengan kandungan Natural AHA + PHA dan Moistbeads yang sustainable</li>
                    </div>
                    <div className="col-md-6">
                      <li> bantu mengangkat sel kulit mati</li>
                    </div>
                    <div className="col-md-6">
                      <li> minyak</li>
                    </div>
                    ...
                    <div className="col-md-6">
                      <li> dan sisa make-up dengan lembut</li>
                    </div>
                  </div>
                </div>
                <div className="row">
                ...
                <div className="product_desc">
                  ...
                  <div className="row mt-2" id="include">
                    <div className="col-md-6">
                      <li>-</li>
                    </div>
                  </div>
                ...
                <div className="product_desc">
                  ...
                  <div className="row mt-2" id="exclude">
                    <div className="col-md-6">
                      <li>-</li>
                    </div>
                  </div>
                ...
                <div className="product_variant quantity">
                  ...
                  <input id="jumlah" min={1} max={100} defaultValue={1} type="number" fdprocessedid="0wtpxd" />
                  <button className="button" type="button" onclick="cartClick()" fdprocessedid="1qc2uj">add to cart</button>
                </div>
                <div className="border-divider" />
                <div className="row mt-2">
                  <div className="col-md-2">
